...
<html lang="fr">
	...
	<body>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			<a class="navbar-brand" href="<?= PATH ?>index.php"><img src="<?= PATH ?>img/logo.png" height="30" /> shop</a>
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item">
						<a class="nav-link" href="<?= PATH ?>index.php"><i class="fa fa-home"></i> Accueil <span class="sr-only">(current)</span></a>
					</li>				
					<?php if(!userConnecte()): ?>
					<li class="nav-item">
		...
		//debug($_SESSION);
		 if(isset($_SESSION['validation'])){
			for($i = 0; $i < count($_SESSION['validation']); $i ++){
				...
				echo '  <strong>Message : </strong>' . $_SESSION['validation'][$i];
